...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 26 20:32:44 2021
...
class GRUDecoder(nn.Module):
    def __init__(self, vocabulary_size, encoder_dim,decoder_dim = 512, dropout = 0,device = 'cpu'):
        ...
        self.attention = GRUAttention(encoder_dim,decoder_dim)
        self.embedding = nn.Embedding(vocabulary_size, decoder_dim)
        self.gru= nn.GRUCell(decoder_dim + encoder_dim, decoder_dim,bias = True)
    ...
    def forward(self,feats,orig_captions,orig_lengths):
        ...
        h = self.init_hidden_state(flat_feats)
        ...
        for t in range(max_length):
          ...
          h = self.gru(cat_att_embeds, h[:t_batch])
